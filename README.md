...
B) Backend: Node.js/Express. Serves two purposes: A) Upon request from the front end, draws data from MongoDB, formats, and then sends the data back. This data is used to create a dashboard. B) Manages a Rabbit message queue (see E).
